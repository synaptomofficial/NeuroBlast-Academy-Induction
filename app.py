...
df = pd.DataFrame(
    [
        {"Batch Name / ID": "e.g., U-15 Boys", "No. of Players": 0, "Gender": "Choose from options", "Age Group": "14-15", "Level of Training": "Choose from options", "Avg. Duration (Months)": 2.0, "Fee (₹ *Not Mandatory)": 0, "Unit": "Choose from options"},
    ]
)
